...
{
	return ((void(*)(const char*, uint16_t*))(g_libGTASA + 0x5A8351))(ascii, gxt);
}
...
{
	return ((void(*)(uint32_t*))(g_libGTASA + 0x5AAFC9))(dwColor);
}

void CFont::SetJustify(uint8_t justify)
{
	return ((void(*)(uint8_t))(g_libGTASA + 0x5AB2F5))(justify);
}

void CFont::SetOrientation(uint8_t orientation)
{
	return ((void(*)(uint8_t))(g_libGTASA + 0x5AB305))(orientation);
}

void CFont::SetWrapX(float wrapX)
{
	return ((void(*)(float))(g_libGTASA + 0x5AB1D9))(wrapX);
}

void CFont::SetCentreSize(float size)
{
	return ((void(*)(float))(g_libGTASA + 0x5AB1E9))(size);
}

void CFont::SetBackground(uint8_t bBackground, uint8_t bOnlyText)
{
	return ((void(*)(uint8_t, uint8_t))(g_libGTASA + 0x5AB2C1))(bBackground, bOnlyText);
}

void CFont::SetBackgroundColor(uint32_t *dwColor)
{
	return ((void(*)(uint32_t*))(g_libGTASA + 0x5AB2D1))(dwColor);
}

void CFont::SetProportional(uint8_t prop)
{
	return ((void(*)(uint8_t))(g_libGTASA + 0x5AB2B1))(prop);
}

void CFont::SetDropColor(uint32_t* dwColor)
{
	return ((void(*)(uint32_t*))(g_libGTASA + 0x5AB219))(dwColor);
}

void CFont::SetDropShadowPosition(uint8_t pos)
{
	return ((void(*)(uint8_t))(g_libGTASA + 0x5A8A6D))(pos);
}
...
void CFont::PrintString(float posX, float posY, const char *string )
{
	...
	// CFont::PrintString
	(( void (*)(float, float, uint16_t*))(g_libGTASA + 0x5AA191))(posX, posY, gxt_string);
	
	delete gxt_string;

	// CFont::RenderFontBuffer
	(( void (*)())(g_libGTASA + 0x5A90B0 + 1))();
